...
const MediumClap = () => {
  ...
  const handleClick = () => {
    setClapState(prevState => ({
      ...
      countTotal: prevState.count < MAXIMUM_CLAPS ? prevState.countTotal + 1 : prevState.countTotal
    }));
  };

  return (
    <button className={styles.clap} onClick={handleClick}>
